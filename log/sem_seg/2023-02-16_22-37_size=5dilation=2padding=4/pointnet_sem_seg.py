...
class get_model(nn.Module):
    def __init__(self, num_class):
        ...
        self.conv1 = torch.nn.Conv1d(1088, 512, 5,dilation=2,padding=4)
        # dilation=2不增加计算量的前提下，增大感受野 若卷积核改为5的话，为保证尺寸不变，加上padding=2
        self.conv2 = torch.nn.Conv1d(512, 256, 5,dilation=2,padding=4)
        self.conv3 = torch.nn.Conv1d(256, 128, 5,dilation=2,padding=4)
