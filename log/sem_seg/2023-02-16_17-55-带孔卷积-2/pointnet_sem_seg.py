...
class get_model(nn.Module):
    def __init__(self, num_class):
        ...
        self.conv1 = torch.nn.Conv1d(1088, 512, 1,dilation=2)
        # dilation=2不增加计算量的前提下，增大感受野
        self.conv2 = torch.nn.Conv1d(512, 256, 1,dilation=2)
        self.conv3 = torch.nn.Conv1d(256, 128, 1,dilation=2)
